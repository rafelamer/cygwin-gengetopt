...
/* ./.libs/lt-sample1.c - temporary wrapper executable for .libs/sample1
   Generated by libtool (GNU libtool) 2.4.6

   The sample1 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "sample1"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sample1 - temporary wrapper script for .libs/sample1\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The sample1 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"sample1:sample1:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sample1:sample1:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sample1:sample1:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
