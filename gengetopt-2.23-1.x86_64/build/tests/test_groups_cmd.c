/*
  ...
  /usr/local/src/cygwin-gengetopt/gengetopt-2.23-1.x86_64/build/tests/../src/.libs/gengetopt --gen-version --input=/usr/local/src/cygwin-gengetopt/gengetopt-2.23-1.x86_64/src/gengetopt-2.23/tests/test_groups_cmd.ggo --func-name=test_groups_cmd_parser --file-name=test_groups_cmd --unnamed-opt --show-required 
...
const char *gengetopt_args_info_usage = "Usage: test_groups [OPTION]... [FILE]...";
...
static int
test_groups_cmd_parser_internal (int argc, char **argv, struct gengetopt_args_info *args_info,
...
{
  printf ("%s %s\n",
     (strlen(TEST_GROUPS_CMD_PARSER_PACKAGE_NAME) ? TEST_GROUPS_CMD_PARSER_PACKAGE_NAME : TEST_GROUPS_CMD_PARSER_PACKAGE),
     TEST_GROUPS_CMD_PARSER_VERSION);
...
int
test_groups_cmd_parser (int argc, char **argv, struct gengetopt_args_info *args_info)
{
  return test_groups_cmd_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
test_groups_cmd_parser_ext (int argc, char **argv, struct gengetopt_args_info *args_info,
                   struct test_groups_cmd_parser_params *params)
{
  int result;
  result = test_groups_cmd_parser_internal (argc, argv, args_info, params, 0);
...
int
test_groups_cmd_parser2 (int argc, char **argv, struct gengetopt_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct test_groups_cmd_parser_params params;
...
test_groups_cmd_parser_required (struct gengetopt_args_info *args_info, const char *prog_name)
{
  ...
  if (test_groups_cmd_parser_required2(args_info, prog_name, 0) > 0)
    result = EXIT_FAILURE;
...
int
test_groups_cmd_parser_internal (
                        ...
                        struct test_groups_cmd_parser_params *params, const char *additional_error)
{
  ...
  if (check_required)
    {
      error_occurred += test_groups_cmd_parser_required2 (args_info, argv[0], additional_error);
    }
