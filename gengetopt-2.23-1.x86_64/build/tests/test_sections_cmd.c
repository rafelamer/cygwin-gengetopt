/*
  ...
  /usr/local/src/cygwin-gengetopt/gengetopt-2.23-1.x86_64/build/tests/../src/.libs/gengetopt --gen-version --input=/usr/local/src/cygwin-gengetopt/gengetopt-2.23-1.x86_64/src/gengetopt-2.23/tests/test_sections_cmd.ggo --func-name=test_sections_cmd_parser --file-name=test_sections_cmd --unnamed-opt --show-required 
...
const char *gengetopt_args_info_usage = "Usage: test_sections [OPTION]... [FILE]...";
