...
#ifndef TEST_SECTIONS_CMD_H
#define TEST_SECTIONS_CMD_H
...
#ifndef TEST_SECTIONS_CMD_PARSER_PACKAGE
/** @brief the program name (used for printing errors) */
#define TEST_SECTIONS_CMD_PARSER_PACKAGE "test_sections"
#endif

#ifndef TEST_SECTIONS_CMD_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define TEST_SECTIONS_CMD_PARSER_PACKAGE_NAME "test_sections"
#endif

#ifndef TEST_SECTIONS_CMD_PARSER_VERSION
/** @brief the program version */
#define TEST_SECTIONS_CMD_PARSER_VERSION "1.0"
#endif
 ...
 */
int test_sections_cmd_parser (int argc, char **argv,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 * @deprecated use test_sections_cmd_parser_ext() instead
 */
int test_sections_cmd_parser2 (int argc, char **argv,
  struct gengetopt_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int test_sections_cmd_parser_ext (int argc, char **argv,
  struct gengetopt_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int test_sections_cmd_parser_dump(FILE *outfile,
  struct gengetopt_args_info *args_info);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int test_sections_cmd_parser_file_save(const char *filename,
  struct gengetopt_args_info *args_info);

/**
 * Print the help
 */
void test_sections_cmd_parser_print_help(void);
/**
 * Print the version
 */
void test_sections_cmd_parser_print_version(void);

/**
 * Initializes all the fields a test_sections_cmd_parser_params structure 
 * to their default values
 * @param params the structure to initialize
 */
void test_sections_cmd_parser_params_init(struct test_sections_cmd_parser_params *params);

/**
 * Allocates dynamically a test_sections_cmd_parser_params structure and initializes
 * all its fields to their default values
 * @return the created and initialized test_sections_cmd_parser_params structure
 */
struct test_sections_cmd_parser_params *test_sections_cmd_parser_params_create(void);
 ...
 */
void test_sections_cmd_parser_init (struct gengetopt_args_info *args_info);
/**
 * Deallocates the string fields of the gengetopt_args_info structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void test_sections_cmd_parser_free (struct gengetopt_args_info *args_info);
 ...
 * @return
 */
int test_sections_cmd_parser_required (struct gengetopt_args_info *args_info,
