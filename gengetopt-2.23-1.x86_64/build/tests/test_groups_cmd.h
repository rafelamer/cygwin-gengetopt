...
#ifndef TEST_GROUPS_CMD_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define TEST_GROUPS_CMD_PARSER_PACKAGE_NAME "test_groups"
#endif
 ...
 */
int test_groups_cmd_parser (int argc, char **argv,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 * @deprecated use test_groups_cmd_parser_ext() instead
 */
int test_groups_cmd_parser2 (int argc, char **argv,
  struct gengetopt_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int test_groups_cmd_parser_ext (int argc, char **argv,
  struct gengetopt_args_info *args_info,
