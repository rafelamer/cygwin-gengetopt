/*
  ...
  /usr/local/src/cygwin-gengetopt/gengetopt-2.23-1.x86_64/build/tests/../src/.libs/gengetopt --gen-version --input=/usr/local/src/cygwin-gengetopt/gengetopt-2.23-1.x86_64/src/gengetopt-2.23/tests/more_than_once_cmd.ggo --func-name=more_than_once_cmd_parser --file-name=more_than_once_cmd --unnamed-opt --show-required 
...
const char *gengetopt_args_info_usage = "Usage: more_than_once [OPTION]... [FILE]...";
...
static int
more_than_once_cmd_parser_internal (int argc, char **argv, struct gengetopt_args_info *args_info,
...
{
  printf ("%s %s\n",
     (strlen(MORE_THAN_ONCE_CMD_PARSER_PACKAGE_NAME) ? MORE_THAN_ONCE_CMD_PARSER_PACKAGE_NAME : MORE_THAN_ONCE_CMD_PARSER_PACKAGE),
     MORE_THAN_ONCE_CMD_PARSER_VERSION);
...
void
more_than_once_cmd_parser_init (struct gengetopt_args_info *args_info)
{
...
int
more_than_once_cmd_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", MORE_THAN_ONCE_CMD_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }
...
void
more_than_once_cmd_parser_free (struct gengetopt_args_info *args_info)
{
...
int
more_than_once_cmd_parser (int argc, char **argv, struct gengetopt_args_info *args_info)
{
  return more_than_once_cmd_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
more_than_once_cmd_parser_ext (int argc, char **argv, struct gengetopt_args_info *args_info,
                   struct more_than_once_cmd_parser_params *params)
{
  int result;
  result = more_than_once_cmd_parser_internal (argc, argv, args_info, params, 0);
...
int
more_than_once_cmd_parser2 (int argc, char **argv, struct gengetopt_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct more_than_once_cmd_parser_params params;
...
int
more_than_once_cmd_parser_required (struct gengetopt_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
...
int
more_than_once_cmd_parser_internal (
                        ...
                        struct more_than_once_cmd_parser_params *params, const char *additional_error)
{
  ...
  if (initialize)
    more_than_once_cmd_parser_init (args_info);

  more_than_once_cmd_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ...
          more_than_once_cmd_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", MORE_THAN_ONCE_CMD_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  more_than_once_cmd_parser_release (&local_args_info);
