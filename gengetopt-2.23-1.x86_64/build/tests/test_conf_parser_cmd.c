/*
  ...
  /usr/local/src/cygwin-gengetopt/gengetopt-2.23-1.x86_64/build/tests/../src/.libs/gengetopt --gen-version --input=/usr/local/src/cygwin-gengetopt/gengetopt-2.23-1.x86_64/src/gengetopt-2.23/tests/test_conf_parser_cmd.ggoconf --func-name=test_conf_parser_cmd_parser --file-name=test_conf_parser_cmd --unnamed-opt=OTHER NAMES --conf-parser --arg-struct-name=my_args_info --no-handle-error 
...
const char *my_args_info_usage = "Usage: test_conf_parser [OPTION]... [OTHER NAMES]...";
...
{
	size_t len_purpose = strlen(my_args_info_purpose);
	size_t len_usage = strlen(my_args_info_usage);
